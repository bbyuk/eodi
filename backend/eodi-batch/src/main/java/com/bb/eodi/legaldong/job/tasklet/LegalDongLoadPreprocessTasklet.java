...
import com.bb.eodi.legaldong.LegalDongLoadBatchJobProperties;
...
import static com.bb.eodi.legaldong.domain.enums.LegalDongLoadKey.*;
...
public class LegalDongLoadPreprocessTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        // total count 조회
        int totalCount = legalDongDataPort.getTotalCount(region);
