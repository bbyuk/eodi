...
-- constraint
ALTER TABLE sell
    ADD CONSTRAINT fk_sell__region_id
...
-- -----------------------------------------------------------------------------------------
-- index
CREATE INDEX idx_sell__ri ON sell(region_id);
CREATE INDEX idx_sell__tn ON sell(target_name);
CREATE INDEX idx_sell__cd ON sell(contract_date);
CREATE INDEX idx_sell__ht ON sell(housing_type);
CREATE INDEX idx_sell__p ON sell(price);
CREATE INDEX idx_sell__nla ON sell(net_leasable_area);
-- -----------------------------------------------------------------------------------------
