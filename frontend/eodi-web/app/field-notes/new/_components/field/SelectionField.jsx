...
export default function SelectionField({ title, value, placeholder, onClick }) {
  return (
    <section className="space-y-3">
      ...
      >
        ...
        <span className={`min-w-0 flex-1 truncate text-sm font-medium ${value ? "text-slate-900" : "text-slate-400"}`}>
          {value || placeholder}
        </span>
